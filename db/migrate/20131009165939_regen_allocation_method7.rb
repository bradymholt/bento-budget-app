class RegenAllocationMethod7 < ActiveRecord::Migration
     def change
...
# IncomeFrequency.create! :name => "Once a Week", :monthly_occurance => 4.333
	...
	AllocationMethod.create! :income_frequency_id => 4, :name => "Once a month, 4 per months", :monthly_occurance => 1, :is_default => false, :description => "You will allocate a full month's worth of income at the same time."
